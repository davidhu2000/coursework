...
ActiveRecord::Schema.define(version: 20161205230745) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.string   "comments_type", null: false
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
  end

  add_index "comments", ["comments_type", "comments_id"], name: "index_comments_on_comments_type_and_comments_id", using: :btree
